...
//---------------------------------------|Detalle - inventario|-------------------------------------
    db.inventario.hasMany(db.detalle_ventas, { foreignKey: "id_inventario", as: "detalle_ventas" });
    db.detalle_ventas.belongsTo(db.inventario, { foreignKey: "id_inventario", as: "inventario" });
//--------------------------------------------------------------------------------------------------
